...
def read_kappa(model,fluid=1,filename='',header=True):
    """
    reads in the columns from dustkappa..inp file, assumes a 4 column file
    Parameters:
    -----------
    model: model_ class object
    ...
    header: boolean, header = True for files generated by optool, False for others
    ...
    wav,kabs,kscat,g = np.loadtxt(kappa_file,skiprows=numrows,unpack=True)
