...
library['default'] = {'Ms': 1, 'Rs': 2.0, 'Ts': 5000, 'accrate':1e-7,'f':0.01, 'Mdisk': 0.06, 'Mfrac': [0.01,0.01],'R0':[5,5], 'Rout':[100,50], 'H0':[1,0.3], 'p':[-1,-1], 'Rdisk':[125,125],'Min': 1e-6, 'Rc':125, 'rho_amb':1e-25, 'rho_0': 3e-22,'theta_min': 25,'exf':0.25,'Rmax':1.5e4, 'd2g': 0.01, 'shock':False,'N':[180,90,48], 'min':[0.1,pi/16.,0], 'max':[400,pi/2.,2*pi], 'spacing':['log','lin','lin'],'rho_si':3.1518, 'amin_chem':0.06, 'amax_ism': 1.0, 'amin': [0.005,0.005], 'amax': [1,1e3], 'apow': [3.5,3.5],'cr_model': 'ssx','zetacr': 1.3e-17, 'LX': 1e30, 'G0':1, 'viscous_heating':False}
