pro b_scatter_dust,g,u,v,w,nu,nv,nw,numscats
    ...
    cosalpha=(0.5/g)*((1.+g^2.)-((1.-g^2.)/(1.-g+2.*g*harvest(0)))^2.)
    ...
    wterm=1/((1-w^2.)^0.5)    ; The w term that appears below, saves comp time
    ...
    ;print, 'New dirn mod:',(nu^2.+nv^2.+nw^2.)^0.5
