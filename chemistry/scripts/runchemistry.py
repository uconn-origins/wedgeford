...
############################################################
def run_zone(inpfile, basedir, environdir, runsdir, outdir, nzones, iofilenm):
...
## run the models
    ...
    try:
        for inpfile in inpfiles:
            result = pool.apply_async(run_zone, args=(inpfile, basedir, environdir, runsdir, outdir, nzones, options.iofil))
